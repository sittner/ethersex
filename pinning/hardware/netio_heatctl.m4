...
ifdef(`conf_HEATCTL', `
  pin(HEATCTL_RADIATOR, PC5, OUTPUT)
  pin(HEATCTL_HOTWATER, PC6, OUTPUT)
  pin(HEATCTL_BURNER, PC2, OUTPUT)
')
ifdef(`conf_HEATCTL_CIRCPUMP', `
  pin(HEATCTL_CIRCPUMP, PC7, OUTPUT)
')
